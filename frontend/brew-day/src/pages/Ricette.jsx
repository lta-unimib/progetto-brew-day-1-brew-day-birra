              ...
              <tr>
                <td>
                  <input
                    ...
                    type="text"
                    style={{ width: "90%", textAlign: "center" }}
                    onChange={(event) => this.setNewRecipeName(event)}
                  ></input>
                </td>
                <td>
                  <input
                    ...
                    type="text"
                    style={{ width: "90%", textAlign: "center" }}
                    onChange={(event) => this.setNewRecipeDescription(event)}
                  ></input>
                </td>
                <td>
                  <Button
  ...
  filterRecipe() {
    fetch(`/api/recipes?name=${this.state.filterName}`)
      ...
      .then((recipesIDsFiltered) => {
        let recipeFiltered = this.state.recipes.filter((recipe) =>
          recipesIDsFiltered.includes(recipe.name)
        );
